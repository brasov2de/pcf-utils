...
exports.getBoolean = exports.getNumber = exports.getJSON = exports.getString = exports.get = exports.clearCache = exports.EnvironmentVariableTypes = void 0;
...
var getString = function (webApi, name) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.get(webApi, name === null || name === void 0 ? void 0 : name.toLowerCase(), EnvironmentVariableTypes.String)];
            case 1:
                res = _a.sent();
...
var getJSON = function (webApi, name) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.get(webApi, name === null || name === void 0 ? void 0 : name.toLowerCase(), EnvironmentVariableTypes.JSON)];
            case 1:
                res = _a.sent();
...
var getNumber = function (webApi, name) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.get(webApi, name === null || name === void 0 ? void 0 : name.toLowerCase(), EnvironmentVariableTypes.Number)];
            case 1:
                res = _a.sent();
                val = res === null || res === void 0 ? void 0 : res.value;
...
var getBoolean = function (webApi, name) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.get(webApi, name === null || name === void 0 ? void 0 : name.toLowerCase(), EnvironmentVariableTypes.Boolean)];
            case 1:
                res = _a.sent();
                val = res === null || res === void 0 ? void 0 : res.value;
