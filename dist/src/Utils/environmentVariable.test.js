        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, environmentVariable_1.EnvironmentVariable.getString(webAPI_1.default, name)];
                case 1:
                    val = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, environmentVariable_1.EnvironmentVariable.getJSON(webAPI_1.default, name)];
                case 1:
                    val = _a.sent();
                    expect(webAPI_1.default.retrieveMultipleRecords).toHaveBeenCalledTimes(1);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, environmentVariable_1.EnvironmentVariable.getJSON(webAPI_1.default, name1)];
                case 1:
                    val = _a.sent();
                    expect(webAPI_1.default.retrieveMultipleRecords).toHaveBeenCalledTimes(1);
                    ...
                    return [4 /*yield*/, environmentVariable_1.EnvironmentVariable.getJSON(webAPI_1.default, name2)];
                case 2:
                    val2 = _a.sent();
