...
var userId;
var get = function (webApi, name, userId, type) { return __awaiter(void 0, void 0, void 0, function () {
...
var getString = function (webApi, name, userId) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, get(webApi, name === null || name === void 0 ? void 0 : name.toLowerCase(), userId, EVType.String)];
            case 1:
                res = _a.sent();
...
var getJSON = function (webApi, name, userId) { return __awaiter(void 0, void 0, void 0, function () {
    var res, val;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, get(webApi, name === null || name === void 0 ? void 0 : name.toLowerCase(), userId, EVType.JSON)];
            case 1:
                res = _a.sent();
...
var getNumber = function (webApi, name, userId) { return __awaiter(void 0, void 0, void 0, function () {
    var res, val;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, get(webApi, name === null || name === void 0 ? void 0 : name.toLowerCase(), userId, EVType.Number)];
            case 1:
                res = _a.sent();
                val = res === null || res === void 0 ? void 0 : res.value;
...
var getBoolean = function (webApi, name, userId) { return __awaiter(void 0, void 0, void 0, function () {
    var res, val;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, get(webApi, name === null || name === void 0 ? void 0 : name.toLowerCase(), userId, EVType.Boolean)];
            case 1:
                res = _a.sent();
                val = res === null || res === void 0 ? void 0 : res.value;
